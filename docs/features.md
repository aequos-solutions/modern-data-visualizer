...
| Support | How the solution is supported when your encounter issues | <span style="color:#5dc418;font-weight:700">Guaranteed by **@aequos**. Major bugs correction within 5 open days.</span> | By the open-source community. No guarantee. If breaks, it breaks |
| Price | | <ul style="list-style: none;color:#5dc418;font-weight:700"><li>799$US/year or 2199$US standalone (lifetime)</li><li>Free upgrades and support</li><li>Unlimited users</li><li>1 license per Office 365 tenant</li></ul> | Free. |
| License agreement | |<span style="color:#5dc418;font-weight:700">Commercial license. EULA at [www.aequos.ca/eula](www.aequos.ca/eula)</span> | MIT License (anyone can reuse the code for commercial purposes)